    ...
    public partial class frmPayment : System.Web.UI.Page
    {
        ...
        protected void btnPay_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                aPaymentInfo.DueAmount = lblDue.Text;
        ...
        public void PrintMoneyReceipt()
        {
            try
            {
                ...
                aPaymentManager.GetShowMoneyReceiptReport(document, hfID.Value, txtPayAmt.Text, lblTolatFee.Text, lblPaidAmount.Text, lblDue.Text);
                document.Close();
                Response.Flush();
                Response.End();
            }
