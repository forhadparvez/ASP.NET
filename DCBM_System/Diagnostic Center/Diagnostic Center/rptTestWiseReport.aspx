<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rptTestWiseReport.aspx.cs" Inherits="Diagnostic_Center.rptTestWiseReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12" style="margin: 0; padding: 0; vertical-align: middle;">
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="box-shadow: 10px 10px 10px 10px #888888;">
            ...
            <fieldset>
                ...
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="margin: 0; padding: 0; vertical-align: middle;">
                    ...
                    <div class="col-lg-2 col-md-2 col-xs-12 col-sm-12" style="margin: 0; padding: 0; vertical-align: middle;">
                        <div class="form-group">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12" style="margin: 0; padding: 0; vertical-align: middle;" align="right">
                        <div class="form-group">
                            <asp:Button ID="txtShow" Text="Show" runat="server" CssClass="btn btn-success" OnClick="txtShow_Click" />
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12" style="margin: 0; padding: 0; vertical-align: middle;" align="right">
                        <div class="form-group">
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="margin: 0; padding: 0; vertical-align: middle;">
                <asp:GridView ID="dgTestHistory" Width="100%" CssClass="table" runat="server" OnRowDataBound="dgTestHistory_RowDataBound"></asp:GridView>
            </div>
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="margin: 0; padding: 0; vertical-align: middle;" align="right">
                <div class="form-group">
                    <asp:Button ID="btnPdf" runat="server" CssClass="btn btn-warning" Text="PDF" OnClick="btnPdf_Click" />
                </div>
            </div>
        </div>
              <br />
