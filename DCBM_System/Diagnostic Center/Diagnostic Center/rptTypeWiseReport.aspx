<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rptTypeWiseReport.aspx.cs" Inherits="Diagnostic_Center.rptTypeWiseReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12" style="margin: 0; padding: 0; vertical-align: middle;">
         ...
         <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" style="box-shadow: 10px 10px 10px 10px #888888;">
