...
namespace Diagnostic_Center
{
    public partial class rptUnpaidBillReport : System.Web.UI.Page
    {
        ...
        protected void txtShow_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable dt = aPaymentManager.GetShowUnpaideReportDetails(txtFromdate.Text, txtToDate.Text);
        ...
        protected void dgTestHistory_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                total += Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "[Bill Amount]"));
            }   
        }
        private void TotalBill()
        {
            GridViewRow row = aPaymentManager.getShowTotal(total,"1");
            if (row != null)
        ...
        protected void btnPdf_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                aPaymentManager.GetShowUnpaidReportDetailsReport(document, txtFromdate.Text, txtToDate.Text);
                document.Close();
                Response.Flush();
                Response.End();
            }
        ...
        {
            Response.Redirect("rptUnpaidBillReport.aspx");
        }
    }
}